...
public class HUDManager : MonoBehaviour {
  ...
  void OnGUI() {
    ...
    // write data
    RobertData robertData = gameManager.robertData;
    livesText.text = new string('c', robertData.lives);
    scoreText.text = "" + robertData.score;
	bombsText.text = "" + GameManager.Instance.robertData.bombs;
