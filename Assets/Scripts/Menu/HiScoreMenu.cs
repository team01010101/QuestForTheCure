...
public class HiScoreMenu : MonoBehaviour {
  ...
  public void Start() {
    playerScoreText.text = GameManager.Instance.robertData.score.ToString();
  }
  ...
  public void advance() {
    if (inputField.enabled) {
      ...
      HiScoreManager.Instance.setHiScore(inputField.text.ToLower(), gameManager.robertData.score);
